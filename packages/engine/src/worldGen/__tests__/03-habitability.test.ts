...
function makeZone(id: string, pluralityTypeId: string, generationWealth: number): ZoneCandidate {
  return { id, pluralityTypeId, generationWealth, tileIds: ['tile-1'], tileCells: [{ x: 0, y: 0 }] };
}

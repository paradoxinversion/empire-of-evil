...
describe("Sidebar", () => {
    ...
    it("calls setActiveScreen with captives when CAPTIVES item is clicked", async () => {
        render(<Sidebar />);
        await userEvent.click(screen.getByText("CAPTIVES"));
        expect(setActiveScreen).toHaveBeenCalledWith("captives");
    });
